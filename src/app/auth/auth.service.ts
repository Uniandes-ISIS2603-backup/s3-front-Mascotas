...
export class AuthService {
    ...
    start (): void {
        ...
        this.permissionsService.loadPermissions(['edit_mascota_permission', 'delete_mascota_permission', 'leave_review']);
    ...
    setAdministratorRole (): void {
        this.roleService.flushRoles();
        this.roleService.addRole('ADMIN', ['edit_mascota_permission', 'delete_mascota_permission']);
